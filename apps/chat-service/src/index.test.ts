...
describe('chat-service startup ordering', () => {
  it('loads config before initializing runtime services and registers Firestore health', async () => {
    ...
    expect(source).toContain('firestoreHealthCheck()');
  });
